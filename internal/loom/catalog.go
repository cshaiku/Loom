...
var Commands = []CommandInfo{
	...
	{"inspect:source", "inspect layout source", "auto-detect SwiftUI or WinUI XAML and report a shared layout tree", "inspection", AccessConditionalWrite, []string{"--output"}, []string{"analyze"}, []string{"loom inspect:source <source-file> [--from swiftui|winui3] [--format text|json] [--output path]"}, []string{"loom inspect:source contentview.swift --json"}},
